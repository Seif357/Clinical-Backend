    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorRequestImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorRequestImages_DoctorRequest_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientResponses_AspNetUsers_SubmittedByUserId",
                        column: x => x.SubmittedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatientResponses_DoctorRequest_DoctorRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientResponseImages_PatientResponses_ResponseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_DoctorProfileId_Status_RequestedAt",
                table: "AppointmentRequests",
                columns: new[] { "DoctorProfileId", "Status", "RequestedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_PatientProfileId",
                table: "AppointmentRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorRequest_DoctorProfileId",
                table: "DoctorRequest",
                column: "DoctorProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorRequest_PatientProfileId_CreatedAt",
                table: "DoctorRequest",
                columns: new[] { "PatientProfileId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_DoctorRequest_RequestType_Status",
                table: "DoctorRequest",
                columns: new[] { "RequestType", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_DoctorRequestImages_RequestId",
                table: "DoctorRequestImages",
                column: "RequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientResponseImages_ResponseId",
                table: "PatientResponseImages",
                column: "ResponseId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientResponses_DoctorRequestId",
                table: "PatientResponses",
                column: "DoctorRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PatientResponses_SubmittedByUserId_SubmittedAt",
                table: "PatientResponses",
